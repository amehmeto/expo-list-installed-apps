...
class ExpoListInstalledAppsModule : Module() {
    ...
    fun getBase64IconImage(appInfo: ApplicationInfo): String {
        try {
            val context: Context = getReactContext()
    ...
    private fun formatAppInfo(packageInfo: PackageInfo): Map<String, String> {
        val context: Context = getReactContext()
    ...
    override fun definition() = ModuleDefinition {
        ...
        Function("listInstalledApps") {
            try {
                ...
                val pkgAppsList = context.packageManager?.getInstalledPackages(PackageManager.GET_META_DATA) ?: emptyList()
